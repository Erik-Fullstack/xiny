...
export default function RowsContainer({ lineCount, scrollTop }: RowsContainerProps) {
    ...
    return (
        <div className="h-full w-12 shrink-0 overflow-hidden border border-input dark:bg-input/60 py-2 text-center text-base text-muted-foreground md:text-sm select-none">
